export default function Footer () {
    return(
        ...
        <div className="bg-[#1b1b1c] w-full h-[40vh] flex flex-row gap-4">
         <aside className="w-100 h-40 flex flex-col gap-2 mt-4 ml-4">
            ...
            <ul className="w-full h-full flex flex-col gap-1 items-start">
                ...
                <li className="text-[#A4A4A4] font-(PP Neue Montreal Normal) text-md  hover:text-white "> <a href="/#about-me">About me</a></li>
        ...
        <div className="w-full pb-6 pl-4 pr-4 sm:pl-7 sm:pr-7 bg-[#1b1b1c] flex flex-row  justify-between">
            ...
            <h2 className="flex items-center"><a className=" text-[#A4A4A4] sm:text-lg text-sm hover:text-white   " href="/#home"> Back to top </a></h2>
            <h2 className="flex items-center"> <a className="text-[#A4A4A4] sm:text-lg text-sm  hover:text-white " href="/Contact-Mateo">Contact Mateo</a></h2>
        </div>
        </>
    )
}