        ...
        <div className="bg-[#1b1b1c] w-full h-[40vh] flex flex-row gap-4">
         <aside className="w-100 h-40 flex flex-col gap-2 mt-4 ml-4">
            ...
            <ul className="w-full h-full flex flex-col gap-1 items-start">
                <li className="text-[#A4A4A4] font-(PP Neue Montreal Normal) text-md  hover:text-white ">Home</li>
                <li className=" text-[#A4A4A4] font-(PP Neue Montreal Normal) text-md  hover:text-white">Projects</li>
                <li className=" text-[#A4A4A4] font-(PP Neue Montreal Normal) text-md  hover:text-white">Cv</li>
            </ul>
         </aside>
